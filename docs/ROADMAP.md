...
Phase 1 implementation and the white-screen/playtest corrections remain preserved in `main`. Phase 2 controller-backed Credits/upgrades/replay/Settings integration, the focused presentation/usability correction and the New game keyboard correction are merged as `2122dde` and live at the documented GitHub Pages URL. Two human sessions are recorded. [Astra’s presentation review](PHASE_2_PRESENTATION_REVIEW.md) gives a **conditional pass**: independent checks pass, and the keyboard correction is now deployed; final acceptance awaits a short check of the changed experience and Astra’s review. The isolated, versioned Ignition candidate remains next. Phase 3 has not begun.
